...
# Load the dataset
file_path = r'C:\Users\halaj\Downloads\turkey_earthquakes(1915-2023_may).csv'
...
cleaned_file_path = r'C:\Users\halaj\Downloads\turkey_earthquakes_cleaned_imputedd.csv'
